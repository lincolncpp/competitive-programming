...
7. - [x] [Suffix automaton](string/suffix_automaton.cpp)
8. - [x] [Z function](string/z.cpp)
9. - [x] [KMP](string/kmp.cpp)
10. - [x] [Trie](string/trie.cpp)
11. - [x] [Lyndon factorization (Duval algorithm)](string/duval.cpp)
12. - [x] [Suffix array](string/suffix_array.cpp)
13. - [x] [Longest Common Prefix (Kasai's algorithm)](string/lcp.cpp)
